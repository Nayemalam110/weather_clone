...
WeatherModelAlt weatherModelAltFromJson(String str) => WeatherModelAlt.fromJson(json.decode(str));

String weatherModelAltToJson(WeatherModelAlt data) => json.encode(data.toJson());
...
class WeatherModelAlt {
    ...
    factory WeatherModelAlt.fromJson(Map<String, dynamic> json) => WeatherModelAlt(
...
class Daily {
    ...
    factory Daily.fromJson(Map<String, dynamic> json) => Daily(
        ...
        weathercode: json["weathercode"] == null ? [] : List<int>.from(json["weathercode"]!.map((x) => x)),
        ...
        apparentTemperatureMax: json["apparent_temperature_max"] == null ? [] : List<double>.from(json["apparent_temperature_max"]!.map((x) => x?.toDouble())),
...
class Hourly {
    ...
    factory Hourly.fromJson(Map<String, dynamic> json) => Hourly(
        ...
        apparentTemperature: json["apparent_temperature"] == null ? [] : List<double>.from(json["apparent_temperature"]!.map((x) => x?.toDouble())),
        precipitation: json["precipitation"] == null ? [] : List<int>.from(json["precipitation"]!.map((x) => x)),
        weathercode: json["weathercode"] == null ? [] : List<int>.from(json["weathercode"]!.map((x) => x)),
        surfacePressure: json["surface_pressure"] == null ? [] : List<double>.from(json["surface_pressure"]!.map((x) => x?.toDouble())),
        visibility: json["visibility"] == null ? [] : List<int>.from(json["visibility"]!.map((x) => x)),
        windspeed10M: json["windspeed_10m"] == null ? [] : List<double>.from(json["windspeed_10m"]!.map((x) => x?.toDouble())),
    );
